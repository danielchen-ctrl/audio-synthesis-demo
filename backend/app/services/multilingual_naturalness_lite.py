...
# --- 内联自 demo_app.lang_utils（V2 适配，无需依赖 V1 模块）---
LANGUAGE_ALIASES: dict[str, str] = {
    "中文": "Chinese", "中文（普通话）": "Chinese", "Chinese": "Chinese", "zh": "Chinese",
    "英语": "English", "英文": "English", "English": "English", "en": "English",
    "日语": "Japanese", "日本語": "Japanese", "Japanese": "Japanese", "ja": "Japanese",
    "韩语": "Korean", "한국어": "Korean", "Korean": "Korean", "ko": "Korean",
    "法语": "French", "French": "French", "fr": "French",
    "德语": "German", "Deutsch": "German", "German": "German", "de": "German",
    "西班牙语": "Spanish", "Español": "Spanish", "Spanish": "Spanish", "es": "Spanish",
    "葡萄牙语": "Portuguese", "Português": "Portuguese", "Portuguese": "Portuguese", "pt": "Portuguese",
    "意大利语": "Italian", "Italian": "Italian", "it": "Italian",
    "俄语": "Russian", "Russian": "Russian", "ru": "Russian",
    "阿拉伯语": "Arabic", "Arabic": "Arabic", "ar": "Arabic",
    "印度尼西亚语": "Indonesian", "印尼语": "Indonesian", "Indonesian": "Indonesian", "id": "Indonesian",
    "粤语": "Cantonese", "Cantonese": "Cantonese",
}
# --- 桩函数：V2 不使用 naturalness YAML 规则（云 LLM 输出无需此后处理）---
def load_text_naturalness_rules() -> dict:  # type: ignore[misc]
    return {}
